...
extern PCF8574_HandleTypeDef	pcf;
extern void DWT_Delay(uint32_t us); // microseconds
...
void LCDI2C_clear(){
	...
	HAL_Delay(300);  // this command takes a long time!
}
...
void LCDI2C_expanderWrite(uint8_t _data)
{
    ...
    PCF8574_Write(&pcf, _data | lcdi2c.backlightval);
}
...
void LCDI2C_pulseEnable(uint8_t _data){
	...
	DWT_Delay(37);		// commands need > 37us to settle
}
...
// Fumction to send string via USART
